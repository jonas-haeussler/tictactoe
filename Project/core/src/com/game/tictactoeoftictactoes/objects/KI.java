...
public class KI implements Runnable {
    private com.game.tictactoeoftictactoes.objects.MapGrid bigMapGrid;
    private com.game.tictactoeoftictactoes.objects.MapGrid[][] smallMapGrids;
    private byte kiPlayer;
    private byte kiLevel;
    private com.game.tictactoeoftictactoes.screens.GameScreen gameScreen;
    private TicTacToeGame game;
    private com.game.tictactoeoftictactoes.objects.MapGrid activeMapGrid;
    public KI(com.game.tictactoeoftictactoes.objects.MapGrid bigMapGrid, com.game.tictactoeoftictactoes.objects.MapGrid[][] smallMapGrids, byte kiPlayer, byte kiLevel, com.game.tictactoeoftictactoes.screens.GameScreen gameScreen, TicTacToeGame game){
    ...
    public void setGridSet(com.game.tictactoeoftictactoes.objects.MapGrid bigMapGrid, com.game.tictactoeoftictactoes.objects.MapGrid[][] smallMapGrids){
        this.bigMapGrid = bigMapGrid;
        this.smallMapGrids = smallMapGrids;
    }
