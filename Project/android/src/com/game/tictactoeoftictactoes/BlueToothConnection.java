...
public class BlueToothConnection implements com.game.tictactoeoftictactoes.utils.ConnectionHandler {
    ...
    public BlueToothConnection(final com.game.tictactoeoftictactoes.TicTacToeGame game, final AndroidLauncher launcher, int requestCode){
        this.game = game;
